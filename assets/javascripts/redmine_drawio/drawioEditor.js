...
window.onDrawioViewerLoad = function() {
    // Check, ob GraphViewer existiert. Wenn nicht, kurz warten und erneut versuchen.
    if (typeof GraphViewer === 'undefined') {
        setTimeout(window.onDrawioViewerLoad, 100);
        return;
    }

    // Ab hier dein bisheriger Code für den Patch:
